...
export const INDICATORS: readonly IndicatorDef[] = [
  ...
  },
  {
    ...
    category: 'fx',
    source: 'ecos',
    sourceId: '731Y001/0000003',
    fallbackSource: 'yfinance',
    fallbackSourceId: 'EURKRW=X',
    unit: 'krw',
    precision: 2,
  ...
  },
  {
    ...
    category: 'fx',
    source: 'ecos',
    sourceId: '731Y001/0000002',
    fallbackSource: 'yfinance',
    fallbackSourceId: 'JPYKRW=X',
    unit: 'krw',
    precision: 2,
    thresholds: { normal: [0, 99999], watch: [0, 99999], alert: [0, 99999], direction: 'above' },
    updateCadence: 'daily',
